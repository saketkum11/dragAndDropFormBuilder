    ...
    <div className="relative z-10 ">
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto text-white   ">
        <div className="flex  items-end justify-center p-4 text-center ">
          <div className="relative overflow-hidden rounded-lg bg-zinc-800 text-left shadow-xl  sm:my-8 sm:w-full sm:max-w-lg ">
            <div className="px-4 py-4 flex flex-col gap-4  min-h-96">
